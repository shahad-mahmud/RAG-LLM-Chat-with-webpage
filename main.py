...
if __name__ == "__main__":
    ...
    know the answer, just say that you don't know, don't try to make up an answer. If
    the user wants a code, write it in ```CODE BLOCK```.

    {context}

    Question: {question}

    Always be polite and respectful. If the user is rude, don't be rude back. If the
    user is being rude, just say that you don't want to talk to them anymore and end
    the conversation.
    """
    ...
    chain = ConversationalRetrievalChain.from_llm(
        ...
        condense_question_prompt=PROMT,
    )
